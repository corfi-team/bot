...
module.exports = {
  ...
  description: "Przywraca dźwięk użytkownikowi",
      ...
      return message.reply({
        ...
        embeds: [
          new MessageEmbed()
            .setColor("RED")
            .setDescription(
              `>>> ${emotki.not} Bot nie posiada permisji do przywracania dźwięku użytkownikom **(**\`🔒 MUTE_MEMBERS\`**)**`
            ),
        ],
      });
    }
      ...
      return message.reply({
        ...
        embeds: [
          new MessageEmbed()
            .setColor("RED")
            .setDescription(
              `>>> ${emotki.not} Nie posiadasz permisji do przywracania dźwięku użytkownikom **(**\`🔒 MUTE_MEMBERS\`**)**`
            ),
        ],
      });
    }
    ...
    if (
      ...
      return message.reply({
        ...
        embeds: [
          new MessageEmbed()
            .setColor("#ff0000")
            .setDescription(
              `>>> ${emotki.not} Nie możesz przywrócić dźwięku użytkownikowi o podobnych permisjach`
            ),
        ],
      });
    } else {
      ...
      message.reply({
        ...
        embeds: [
          new MessageEmbed()
            .setDescription(
              `>>> ${emotki.tak} Przywróciłeś dźwięk dla **${member.user.tag}** na kanale głosowym ${member.voice.channel}\n\n\`\`\`diff\n- ${reason}\n\`\`\``
            )
            .setColor("GREEN")
            .setFooter(
