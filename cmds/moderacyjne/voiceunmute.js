...
module.exports = {
  ...
  description: "Odcisza użytkownika na kanale głosowym",
      ...
      return message.reply({
        ...
        embeds: [
          new MessageEmbed()
            .setColor("RED")
            .setDescription(
              `>>> ${emotki.not} Bot nie posiada permisji do odciszania na kanale głosowym **(**\`🔒 MUTE_MEMBERS\`**)**`
            ),
        ],
      });
    }
      ...
      return message.reply({
        ...
        embeds: [
          new MessageEmbed()
            .setColor("RED")
            .setDescription(
              `>>> ${emotki.not} Nie posiadasz permisji do odciszania na kanale głosowym **(**\`🔒 MUTE_MEMBERS\`**)**`
            ),
        ],
      });
    }
    ...
    if (
      ...
      message.reply({
        ...
        embeds: [
          new MessageEmbed()
            .setDescription(
              `>>> ${emotki.tak} Odciszyłeś **${member.user.tag}** na kanale głosowym ${member.voice.channel}\n\n\`\`\`diff\n- ${reason}\n\`\`\``
            )
            .setColor("GREEN")
            .setFooter(
      ...
      const sex = new MessageEmbed()
        .setColor(`2f3136`)
        .setAuthor(
          `🕵️‍♂️ Użytkownik został odciszony na kanale głosowym ${member.user.tag}`
        )
        .addField(
          `\`💥\` Odciszono:`,
